            ...
            <li v-for="(result, index) in results" class="project_item" v-if="results">
               ...
               <div class="project_item_bottom">
                  ...
                  <ul class="activities_list">
                     <li v-for="(activity, i) in result.activities" class="activity_item" :class=" activity.priority == '1' ? 'urgent' : '' ">
                        ...
                        <div class="activity_item_right">
                           <input type="text" v-model="newSubActivity" @keyup.enter="createNewSubActivity(activity.id)">
                           <ul class="sub_activities_list">
                              <li v-for="subAct in activity.subActivities">{{ subAct.title }}</li>
                           </ul>
                        </div>
                        ...
                        <div v-if="activity.openEditForm" class="edit_activity_form">
                           ...
                           <div class="form_group">
                              <label for="priority">Priorità: </label>
                              <input type="checkbox" v-model="activityOpt.editActivity.priority" >
                           </div>
                           <div class="form_group">
                              <label for="maker">Creatore: </label>
